...
if (!empty($proveedor_filter)) {
    $query .= " AND ia.id_pr = " . intval($proveedor_filter);
}

$query .= " ORDER BY ia.existencia ASC";  // Ordenar por menor existencia primero
        ...
        <tbody>
            <?php if (!empty($articulos)): ?>
                <?php foreach ($articulos as $art): 
                    $stock_class = ($art['existencia'] <= $art['min_stock']) ? 'stock-low' : 'stock-ok';
                ?>
                    <tr class="<?php echo $stock_class; ?>">
                        ...
                        <!--<td><?php echo htmlspecialchars($art['proveedor'] ?? 'N/A'); ?></td>-->
