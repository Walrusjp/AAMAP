...
// 2. Consulta modificada para filtrar solo categoría 7 (Rotecna)
$sql = "SELECT m.*, i.codigo, i.descripcion as item_desc, u.username as usuario, 
               ca.categoria as nombre_categoria, ca.descripcion as descripcion_categoria
        FROM movimientos_almacen m
        INNER JOIN inventario_almacen i ON m.id_alm = i.id_alm
        INNER JOIN categorias_almacen ca ON i.id_cat_alm = ca.id_cat_alm
        LEFT JOIN users u ON m.id_usuario = u.id
        WHERE i.id_cat_alm = 7  -- Filtro para solo categoría Rotecna
        ORDER BY m.fecha_mov DESC";

$result = $conn->query($sql);

// Obtener el nombre de la categoría para el título (solo una vez)
$categoria_nombre = "Rotecna";
...
<head>
    ...
    <title>Histórico de Movimientos - <?php echo htmlspecialchars($categoria_nombre); ?></title>
    <style>
        .categoria-header {
            color: #070842;
            font-style: italic;
    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <!--<div class="categoria-header">Categoría: <?php echo htmlspecialchars($categoria_nombre); ?></div>-->
            </div>
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" style="text-align: center;">No se encontraron movimientos para esta categoría</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
